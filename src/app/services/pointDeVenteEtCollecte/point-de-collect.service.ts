...
import { DirectionsResponse, MapPoint, PointCollecte, SchedulePickupResponse } from 'src/app/entities/pointDeVenteEtCollecte/point-de-collect';

@Injectable({
  providedIn: 'root'
})
export class PointCollecteService {
  private baseUrl = 'http://localhost:8082/ecoCycleTech/PointCollect';
  ...
  findNearestPoint(lat: number, lng: number, address: string): Observable<PointCollecte> {
