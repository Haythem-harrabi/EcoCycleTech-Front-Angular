...
export class DemandeRecyclageService {
  ...
  private apiUrl = 'http://localhost:8082/ecoCycleTech/demandeRecyclage';
  ...
  getCertificatByDemandeId(demandeId: number): Observable<CertificatRecyclage> {
    return this.http.get<CertificatRecyclage>(`http://localhost:8082/ecoCycleTech/certificatRecyclage/byDemande/${demandeId}`);
  }
