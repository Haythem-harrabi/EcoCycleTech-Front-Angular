...
//user dependent
  ...
  constructor(private messageService: MessageService, private cloudinaryService : CloudinaryService, private fichierService : FichierService,
    private subscriptionService : SubscriptionService,  private router: Router, private espaceService : EspaceStockageService, private auth: AuthService
  ) {}
...
this.rootFolder=this.rootFolder+this.currentUser.username+ "_" + this.currentUser.id;
this.currentFolder=this.currentFolder+this.currentUser.username+ "_" + this.currentUser.id;
