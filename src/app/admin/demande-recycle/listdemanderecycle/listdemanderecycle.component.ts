...
@Component({
  selector: 'app-listdemanderecycle',
  templateUrl: './listdemanderecycle.component.html',
  styleUrls: ['./listdemanderecycle.component.css']
 // encapsulation: ViewEncapsulation.None
})
export class ListdemanderecycleComponent implements OnInit, AfterViewInit {
  Etat = Etat; // Expose the enum to the template
  etatOptions: string[] = Object.values(Etat);
...
sortDirection: 'asc' | 'desc' = 'asc';
  ...
  if (!(form.valid as boolean) || !this.validateForm()) {
    ...
    edit(d: any): void {
      ...
      if (d.dateCreationDemandeRecyclage) {
        ...
        this.demande.dateCreationDemandeRecyclage = dt;
      }
    ...
    resetForm(): void {
      ...
      this.demande = {
        ...
        dateCreationDemandeRecyclage: new Date(this.today),
        descriptionDemandeRecyclage: '',
        nbrAppareils: 0,
        etatDemandeRecyclage: Etat.NONAFFECTEE,
        prixDemandeRecyclage: 0
